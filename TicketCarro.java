 ...
 * @version 1.0
 */
public class TicketCarro extends Vehiculo{
     ...
     */
    public TicketCarro(int noEstacionamiento, String placa, String horaYFecha, double precioTarifa, TipoVehiculo tipoVehiculo) {
        super(noEstacionamiento, placa, horaYFecha, precioTarifa, tipoVehiculo);
    }
    
    /**
     * Este es un metodo que se utiliza para hacer el calculo del monto total a pagar para los carros
